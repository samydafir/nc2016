...
\label{sec:genprog}
Genetic Programming tries to solve a complex problem by evolution.
...
Individuals with a high fitness value are considered fitter and are candidates for evolution.
The are then evolved by mutation or crossover.
We will further use the example of a Genetic Programming poker player with a common tree representation.
