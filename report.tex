...
In the following article we will explain our way from the general rules of a poker game to the final results of our project. \\
The goal is to improve an existing genetic programming poker player by providing additional information about the game.
To achieve this, basic knowledge about evolution and genetic programming is needed. We will explain everything needed to know, so that anyone reading this article can follow our steps. \\
